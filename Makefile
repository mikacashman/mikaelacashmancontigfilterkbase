SERVICE = mikaelacashmancontigfilterkbase
SERVICE_CAPS = mikaelacashmancontigfilterkbase
SPEC_FILE = mikaelacashmancontigfilterkbase.spec
URL = https://kbase.us/services/mikaelacashmancontigfilterkbase
DIR = $(shell pwd)
LIB_DIR = lib
SCRIPTS_DIR = scripts
TEST_DIR = test
