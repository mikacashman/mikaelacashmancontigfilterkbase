package mikaelacashmancontigfilterkbase::mikaelacashmancontigfilterkbaseClient;
...
mikaelacashmancontigfilterkbase::mikaelacashmancontigfilterkbaseClient

=head1 DESCRIPTION


A KBase module: mikaelacashmancontigfilterkbase
...
sub new
{
    ...
    my $self = {
	client => mikaelacashmancontigfilterkbase::mikaelacashmancontigfilterkbaseClient::RpcClient->new,
	url => $url,
	headers => [],
    };
...
<pre>
$params is a mikaelacashmancontigfilterkbase.FilterContigsParams
$return is a mikaelacashmancontigfilterkbase.FilterContigsResults
FilterContigsParams is a reference to a hash where the following keys are defined:
	workspace has a value which is a mikaelacashmancontigfilterkbase.workspace_name
	contigset_id has a value which is a mikaelacashmancontigfilterkbase.contigset_id
...
FilterContigsResults is a reference to a hash where the following keys are defined:
	...
	new_contigset_ref has a value which is a mikaelacashmancontigfilterkbase.ws_contigset_id
...
# Authentication: required
	...
	method => "mikaelacashmancontigfilterkbase.filter_contigs",
	params => \@args,
    });
    if ($result) {
	if ($result->is_error) {
...
<pre>
$params is a mikaelacashmancontigfilterkbase.FilterContigsMaxParams
$return is a mikaelacashmancontigfilterkbase.FilterContigsResults
...
# Authentication: required
    ...
    my $result = $self->{client}->call($self->{url}, $self->{headers}, {
	method => "mikaelacashmancontigfilterkbase.filter_contigs_max",
	params => \@args,
    });
    if ($result) {
	if ($result->is_error) {
...
sub version {
    my ($self) = @_;
    my $result = $self->{client}->call($self->{url}, $self->{headers}, {
        method => "mikaelacashmancontigfilterkbase.version",
        params => [],
    });
    if ($result) {
        if ($result->is_error) {
...
sub _validate_version {
    ...
    if ($sMinor > $cMinor) {
        warn "New client version available for mikaelacashmancontigfilterkbase::mikaelacashmancontigfilterkbaseClient\n";
    }
    if ($sMajor == 0) {
        warn "mikaelacashmancontigfilterkbase::mikaelacashmancontigfilterkbaseClient version is $svr_version. API subject to change.\n";
    }
}
...
Implement new input parameters for the new app we are creating
...
package mikaelacashmancontigfilterkbase::mikaelacashmancontigfilterkbaseClient::RpcClient;
