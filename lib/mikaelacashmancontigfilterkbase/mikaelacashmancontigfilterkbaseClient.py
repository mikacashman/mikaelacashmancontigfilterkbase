...
class mikaelacashmancontigfilterkbase(object):
    ...
    def filter_contigs(self, params, json_rpc_context = None):
        ...
        resp = self._call('mikaelacashmancontigfilterkbase.filter_contigs',
    ...
    def filter_contigs_max(self, params, json_rpc_context = None):
        ...
        resp = self._call('mikaelacashmancontigfilterkbase.filter_contigs_max',
                          [params], json_rpc_context)
        return resp[0]
